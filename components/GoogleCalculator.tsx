            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl font-semibold">
                  Google Inbox Cost Savings Calculator
                </h1>
                <p className="text-muted-foreground text-sm sm:text-base">
                  Calculate Google email infrastructure cost savings
                </p>
              </div>
            </div>
            {googleResults && (
      ...
      <main className="max-w-7xl mx-auto p-4 sm:p-6">
        ...
        >
          ...
          <div
            className={cn(
              "space-y-6",
              googleResults ? "lg:col-span-1" : "lg:col-span-2"
            )}
          >
            <form onSubmit={handleSubmitGoogle(onSubmitGoogle)}>
              <div
                className={cn(
                  "grid gap-6",
                  googleResults ? "grid-cols-1" : "grid-cols-1 md:grid-cols-2"
                )}
              >
                {/* Current Costs */}
                <Card className="border-2 border-blue-100 shadow-lg hover:shadow-xl transition-all duration-300">
                  <CardHeader className="bg-gradient-to-br from-blue-50 to-indigo-50 border-b border-blue-200">
                    ...
                    <CardDescription className="text-blue-600">
                      Enter your current Google email infrastructure costs
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4 pt-6">
                    <div>
                      ...
                      <Input
                        ...
                        step="0.01"
                        {...registerGoogle(
                          "currentCosts.emailSequencerCost",
                          { valueAsNumber: true }
                        )}
                        placeholder="97"
                    ...
                    <div>
                      <Label
                        htmlFor="currentCosts.inboxesPerDomain"
                        className="text-sm font-medium text-gray-700"
                      >
                    ...
                    <div>
                      <Label
                        htmlFor="currentCosts.costPerInbox"
                        className="text-sm font-medium text-gray-700"
                      >
                  ...
                  <CardContent className="space-y-4 pt-6">
                    <div>
                      ...
                      <Input
                        ...
                        type="number"
                        step="0.01"
                        {...registerGoogle("ourOffer.emailSequencerCost", {
                          valueAsNumber: true,
                        })}
                        placeholder="70"
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        type="number"
                        {...registerGoogle("ourOffer.desiredDailyVolume", {
                          valueAsNumber: true,
                        })}
                        placeholder="2000"
                        className="mt-1 border-gray-300 focus:border-green-500 focus:ring-green-500"
                    ...
                    <div>
                      <Label
                        htmlFor="ourOffer.inboxesPerDomain"
                        className="text-sm font-medium text-gray-700"
                      >
                        How many inboxes per domain do you want?
                      </Label>
                      <Input
                        id="ourOffer.inboxesPerDomain"
                        type="number"
                        {...registerGoogle("ourOffer.inboxesPerDomain", {
                          valueAsNumber: true,
                        })}
                        placeholder="3"
                        className="mt-1 border-gray-300 focus:border-green-500 focus:ring-green-500"
                    ...
                    <div>
                      <Label
                        htmlFor="ourOffer.sendsPerInbox"
                        className="text-sm font-medium text-gray-700"
                      >
                        Number of sends per inbox (editable)
                      </Label>
                      <Input
                        id="ourOffer.sendsPerInbox"
                        type="number"
                        {...registerGoogle("ourOffer.sendsPerInbox", {
                          valueAsNumber: true,
                        })}
                        placeholder="30"
                        className="mt-1 border-gray-300 focus:border-green-500 focus:ring-green-500"
                    ...
                    <div>
                      <Label
                        htmlFor="ourOffer.costPerInbox"
                        className="text-sm font-medium text-gray-700"
                      >
                        Our cost per inbox per month
                      </Label>
                      <Input
                        id="ourOffer.costPerInbox"
                        type="number"
                        step="0.01"
                        {...registerGoogle("ourOffer.costPerInbox", {
                          valueAsNumber: true,
                        })}
                        placeholder="3.5"
                        className="mt-1 border-gray-300 focus:border-green-500 focus:ring-green-500"
                    ...
                    {!watchGoogle("ourOffer.useExistingDomains") && (
                      <div>
                        <Label
                        ...
                        <Input
                          ...
                          type="number"
                          step="0.01"
                          {...registerGoogle("ourOffer.costForDomains", {
                            valueAsNumber: true,
                          })}
                          placeholder="11.99"
                          className="mt-1 border-gray-300 focus:border-green-500 focus:ring-green-500"
